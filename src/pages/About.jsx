...
export default function About() {
  return (
    <PageTransition>
      <PageHero
        tag="About Us"
        title="We're <em style='color:#C9A84C;font-style:italic;'>BlackQuill.</em>"
        ...
        <div className="max-w-[1300px] mx-auto grid lg:grid-cols-2 gap-20 items-center">
          <Reveal from="right">
            ...
            <h2 className="h-xl text-white mb-7">
              ...
              <em style={{ color: '#C9A84C', fontStyle: 'italic' }}>your strategic objectives.</em>
            </h2>
          ...
          <StaggerReveal className="grid grid-cols-2 gap-4">
            {[
              ...
              <div key={s.sub} className="card p-7 text-center">
                <div className="font-display font-bold italic mb-2" style={{ fontSize: 'clamp(2rem,4vw,3rem)', letterSpacing: '-.04em', color: '#C9A84C' }}>{s.value}</div>
                <div className="font-mono text-[10px] tracking-wider uppercase" style={{ color: 'rgba(245,240,232,0.3)' }}>{s.sub}</div>
              </div>
            ))}
          </StaggerReveal>
        </div>
      ...
      <section className="py-24 px-6 lg:px-10" style={{ background: '#0d0d11' }}>
        <div className="max-w-[1300px] mx-auto">
          <Reveal className="mb-14">
            ...
            <div className="h-[1px] w-12 mb-6" style={{ background: 'rgba(201,168,76,0.4)' }} />
            <h2 className="h-xl text-white">What it's like<br /><em style={{ color: '#C9A84C', fontStyle: 'italic' }}>working with us</em></h2>
          </Reveal>
          <StaggerReveal className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {HOW.map((h, i) => (
              <div key={i} className="card p-8">
                <div className="font-mono text-[10px] tracking-widest uppercase mb-5" style={{ color: 'rgba(201,168,76,0.4)' }}>{String(i + 1).padStart(2, '0')}</div>
                <div className="h-[1px] w-8 mb-5" style={{ background: 'rgba(201,168,76,0.3)' }} />
      ...
      <section className="py-24 px-6 lg:px-10" style={{ background: '#0B0B0F' }}>
        <div className="max-w-[1300px] mx-auto">
          <Reveal className="mb-14">
            ...
            <div className="h-[1px] w-12 mb-6" style={{ background: 'rgba(201,168,76,0.4)' }} />
            <h2 className="h-xl text-white">What we<br /><em style={{ color: '#C9A84C', fontStyle: 'italic' }}>stand for</em></h2>
          </Reveal>

          <div style={{ borderTop: '1px solid rgba(201,168,76,0.1)' }}>
            {VALUES.map((v, i) => (
              <Reveal key={v.num} delay={i * 0.08}>
                <div className="flex flex-col md:flex-row md:items-start gap-6 py-10" style={{ borderBottom: '1px solid rgba(201,168,76,0.1)' }}>
                  <span className="font-mono text-[10px] tracking-widest uppercase shrink-0 pt-1" style={{ color: 'rgba(201,168,76,0.35)', minWidth: 36 }}>{v.num}</span>
                  <div className="h-[1px] w-8 mt-3 shrink-0 hidden md:block" style={{ background: 'rgba(201,168,76,0.3)' }} />
                  <div>
      ...
      <section className="py-28 px-6 lg:px-10" style={{ background: '#0d0d11' }}>
        <div className="max-w-[1300px] mx-auto">
          <Reveal className="mb-14">
            ...
            <div className="h-[1px] w-12 mb-6" style={{ background: 'rgba(201,168,76,0.4)' }} />
            <h2 className="h-xl text-white">Happy clients<br /><em style={{ color: '#C9A84C', fontStyle: 'italic' }}>tell you more</em></h2>
          </Reveal>
      ...
      <section className="py-20 px-6 lg:px-10" style={{ background: '#C9A84C' }}>
        <div className="max-w-[1300px] mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="shrink-0">
            ...
            <Link to="/contact" className="btn-outline" style={{ borderColor: 'rgba(11,11,15,0.3)', color: '#0B0B0F' }}>
              Work with us →
            </Link>
          </div>
        </div>
      ...
      <section className="py-24 px-6 lg:px-10 text-center relative overflow-hidden"
        style={{ background: 'radial-gradient(ellipse 70% 60% at 50% 50%, rgba(201,168,76,0.07) 0%, transparent 60%), #0B0B0F' }}>
        ...
        <Reveal className="relative z-10 max-w-2xl mx-auto">
          ...
          <h2 className="h-xl text-white mb-8">Ready to work<br /><em style={{ color: '#C9A84C', fontStyle: 'italic' }}>with BlackQuill?</em></h2>
