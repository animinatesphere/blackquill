...
export default function Services() {
  ...
  return (
    <PageTransition>
      <PageHero
        tag="Our Services"
        title="How BlackQuill<br/><em style='color:#C9A84C;font-style:italic;'>can help you</em>"
          ...
          <StaggerReveal className="grid sm:grid-cols-2 gap-5">
            {SERVICES.map(s => (
              <motion.div
                ...
                style={{ background: 'rgba(255,255,255,0.025)', border: '1px solid rgba(201,168,76,0.12)', minHeight: 220 }}
              ...
              >
                ...
                <div className="absolute top-0 left-0 w-8 h-8 pointer-events-none"
                  style={{ borderTop: `1.5px solid rgba(201,168,76,${hovered === s.id ? '0.5' : '0.2'})`, borderLeft: `1.5px solid rgba(201,168,76,${hovered === s.id ? '0.5' : '0.2'})`, transition: 'all 0.3s' }} />

                <div className="relative z-10">
                  <div className="flex items-start justify-between mb-5">
                    <span className="font-mono text-[10px] tracking-[0.2em] uppercase" style={{ color: 'rgba(201,168,76,0.4)' }}>{s.num}</span>
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {s.features.slice(0, 3).map(f => (
                      <span key={f} className="font-mono text-[9px] tracking-wide px-2 py-1 rounded-sm"
                        style={{ background: 'rgba(201,168,76,0.07)', border: '1px solid rgba(201,168,76,0.14)', color: 'rgba(201,168,76,0.6)' }}>
                        {f}
                      </span>
                    ))}
                    {s.features.length > 3 && (
      ...
      <section className="py-16 pb-28 px-6 lg:px-10" style={{ background: '#0d0d11' }}>
        <div className="max-w-[1300px] mx-auto">
          <Reveal className="mb-12">
            ...
            <div className="h-[1px] w-12 mb-6" style={{ background: 'rgba(201,168,76,0.4)' }} />
            <h2 className="h-xl text-white">Everything we do,<br /><em style={{ color: '#C9A84C', fontStyle: 'italic' }}>in detail</em></h2>
          </Reveal>
          <Reveal>
      ...
      <section className="py-24 px-6 lg:px-10" style={{ background: '#0B0B0F' }}>
        <div className="max-w-[1300px] mx-auto">
          <Reveal className="mb-14">
            ...
            <div className="h-[1px] w-12 mb-6" style={{ background: 'rgba(201,168,76,0.4)' }} />
            <h2 className="h-xl text-white">How we<br /><em style={{ color: '#C9A84C', fontStyle: 'italic' }}>work with you</em></h2>
          </Reveal>
          <StaggerReveal className="grid md:grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              ...
              <div key={p.step} className="card p-7">
                <div className="font-mono text-[10px] tracking-widest uppercase mb-5" style={{ color: 'rgba(201,168,76,0.4)' }}>{p.step}</div>
      ...
      <section className="py-24 px-6 lg:px-10 text-center relative overflow-hidden"
        ...
        <Reveal className="relative z-10 max-w-2xl mx-auto">
          ...
          <h2 className="h-xl text-white mb-6">Let's build your<br /><em style={{ color: '#C9A84C', fontStyle: 'italic' }}>author platform</em></h2>
